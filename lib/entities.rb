...
module Entities
  class Graders
    ...
    def assign(submissions)
      ...
      return Common::Result.failure([:invalid_submissions, invalid_submissions]) unless invalid_submissions.empty?
    ...
    def validate
      ...
      return Common::Result.failure([:invalid_graders, invalids]) unless invalids.empty?

      return Common::Result.failure([:no_workload]) unless total_workload > 0
